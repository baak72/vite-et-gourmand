...
const RegisterView = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center pt-32 pb-32 px-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-lg relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-amber-500 font-bold tracking-widest uppercase mb-2 text-xl md:text-2xl">Nouveau Client</h1>
          <p className="text-zinc-400 text-sm font-montserrat">Créez votre compte pour commander vos menus d'exception</p>
        </div>

        <div className="bg-zinc-900/80 backdrop-blur-sm border border-white/10 rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-10">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="Dupont"
                    {...register("nom")}
                    className="w-full bg-zinc-950/50 border border-zinc-800 text-white rounded-xl pl-10 pr-4 py-3.5 text-sm focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all placeholder:text-zinc-700"
                  />
                </div>
            ...
            <button
              ...
              className="w-full bg-amber-500 text-black font-montserrat font-bold uppercase tracking-widest py-4 rounded-xl hover:bg-amber-400 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:hover:scale-100 shadow-[0_0_20px_rgba(245,158,11,0.2)] flex items-center justify-center gap-2 mt-6"
            >
              {isSubmitting ? (
                "Création en cours..."
              ) : (
        ...
        {/* Lien vers Login */}
        <p className="text-center text-zinc-500 mt-8 text-sm pb-8">
          Déjà un compte ?
          <Link to="/login" className="font-bold text-white hover:text-amber-500 transition-colors ml-2 inline-flex items-center gap-1 group py-2">
